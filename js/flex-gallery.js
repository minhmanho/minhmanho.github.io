...
($ => {
    ...
    $.fn.addFlexImages = function(media, shuffling=false) {
         ...
         */
        let images = media.images.slice(), texts, ids;
        // if(media.links)
        ...
        return this.each(() => {
            ...
            /**
             * Puts images into the #fcontainer.
             */
            indices.forEach((index) => {
                /**
                 * Creates and inserts <a> with <img> in the fcontainer.
                 */
                $("#fcontainer").addClass("fg-container").append(
                    $("<div>").addClass("fg-item").append(
                        $("<a>").attr("onclick", "showGallery(" + ids[index].toString() + ")").append(
                            $("<img>").addClass("fg-img")
